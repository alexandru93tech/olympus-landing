...
function SocialIcon({ children }: { children: React.ReactNode }) {
  return (
    <div className="w-10 h-10 rounded-lg bg-[#1e1e1e] flex items-center justify-center text-gray-400 hover:text-white transition-colors cursor-pointer">
      {children}
    </div>
  );
}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-3">
            <span className="bg-[#2a2a2a] rounded-lg px-4 py-2 text-gray-400 text-sm tabular-nums">
              {new Date().toLocaleTimeString('ro-RO', { hour: '2-digit', minute: '2-digit', second: '2-digit' })}
            </span>
            <div className="border-l border-white/10 h-8" />
            <div className="w-10 h-7 rounded-sm overflow-hidden flex">
        ...
        {/* Footer links */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-10 text-sm text-left max-w-4xl mx-auto">
          <div>
